...
Which of the following test suites would make a path-complete glass box test
suite for `maxOfThree`?

Answer
-------

- [X] Test Suite A: `maxOfThree(2, -10, 100)`, `maxOfThree(7, 9, 10)`,
...
- [ ] Test Suite C: `maxOfThree(0, 0, 0)`, `maxOfThree(-3, -10, -1)`,
      `maxOfThree(10, 30, 100)`, `maxOfThree(0, -9, 11)`,
      `maxOfThree(-10, 0, 30)`
